    ...
    public class SmartContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder) 
        {
            builder.Entity<AlunoDisciplina>()
                .HasKey(AD => new {AD.AlunoId, AD.DisciplinaId}); // Fazendo a relação muitos para muitos

            builder.Entity<AlunoCurso>()
                .HasKey(AC => new {AC.AlunoId, AC.CursoId}); // Fazendo a relação muitos para muitos


            builder.ApplyConfigurationsFromAssembly(typeof(SmartContext).Assembly);
